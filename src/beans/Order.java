...
public Order(){
  ...
  @Override public String toString() {
      return String.format("Order: %f<br><br>Bought with the card: %s - **** **** **** %s for Rs. %d<br><br>Products:", 
        this.confNumber ,this.name, this.card.substring(this.card.length() - 4), this.total_price);
  }
